...
export function VerifyEmail({ userName, verifyUrl }: VerifyEmailProps) {
  return (
    <Html lang="fr">
      <Head />
      <Preview>Confirme ton adresse email — Adopte Ton Dev</Preview>
        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.card}>
            ...
            <Text style={styles.text}>
              Merci de ton inscription sur <strong>Adopte Ton Dev</strong>.
              Confirme ton adresse email pour pouvoir postuler aux offres.
            </Text>
            ...
            <Text style={styles.textSmall}>
              Si tu n&apos;es pas à l&apos;origine de cette inscription, ignore
              cet email.
            </Text>
