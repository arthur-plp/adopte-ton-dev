      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Section style={styles.card}>
            <Heading style={styles.heading}>Nouveau message</Heading>

            <Text style={styles.text}>Bonjour {recipientName},</Text>

            <Text style={styles.text}>
              <strong>{senderName}</strong> t&apos;a envoyé un message :
            </Text>

            <Text style={styles.quote}>&laquo; {contentPreview} &raquo;</Text>
