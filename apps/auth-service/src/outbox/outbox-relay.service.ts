...
// Prisma v7 + PrismaPg driver adapter ne crée pas les model delegates quand
// on instancie PrismaClient programmatiquement. On utilise un client HTTP
// minimal pour interroger la table OutboxEvent via $queryRaw.
...
export class OutboxRelayService implements OnModuleInit, OnModuleDestroy {
  ...
  async flush(): Promise<void> {
    ...
    // Requête directe via pg pour éviter les problèmes de driver adapter Prisma v7
